...
import { EditStoryApi, FetchStoryApi } from "../Utils/api";
...
export default function EditStory() {
  ...
  useEffect(() => {
    async function fetchStory() {
      try {
       ...
       const response = await FetchStoryApi(storyId,authToken); 
  ...
  async function updateStory(event) {
    ...
    try {
      const response = await EditStoryApi(storyId,storyData,authToken)
